...
namespace E_APP02.SERVICES.AI_SERVICES.IMAGE_EDIT
{
    internal class Image_Edit02
    {
        ...
        public readonly List<Ai_Set_Model01> collectiondata01 = new List<Ai_Set_Model01>();
        private static readonly string[] data01 = new string[10];
        private static readonly List<string> request_id = new List<string>();
        private static readonly List<string> log_id = new List<string>();
        private static readonly List<int> error_code = new List<int>();
        private static readonly List<string> error_code_str = new List<string>();
        private static readonly List<string> error_msg = new List<string>();
        private static readonly List<int> status_code = new List<int>();
        private static readonly List<string> code = new List<string>();
        private static readonly List<string> code_message = new List<string>();
        private static readonly List<string> message = new List<string>();
        private static readonly List<string> task_type = new List<string>();
        private static readonly List<string> task_id = new List<string>();
        public static  List<string> hair_color = new List<string>();
        public static  List<string> hair_type = new List<string>();
        private static readonly List<string> hair_color_code = new List<string>();
        private static readonly List<string> hair_type_code = new List<string>();
