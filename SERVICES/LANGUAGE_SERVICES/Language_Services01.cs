...
namespace E_APP02.SERVICES.LANGUAGE_SERVICES
{
    internal class Language_Services01
    {
        ...
        private static List<string> trans = new List<string>();
        private static List<string> source_language_code = new List<string>();
        private static List<string> source_language = new List<string>();
        private static List<int> trust_level = new List<int>();
        private static List<string> code = new List<string>();
        private static List<string> language = new List<string>();
        private static List<string> source_lang = new List<string>();
        private static List<int> trust_level01 = new List<int>();
        private static List<string> source_lang_code = new List<string>();
        private static List<string> lowercase01 = new List<string>();
        private static List<string> lowercase02 = new List<string>();
        private static Sql_Services01 Sql_Serv04 = new Sql_Services01();
