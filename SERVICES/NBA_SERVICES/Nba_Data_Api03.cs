...
namespace E_APP02.SERVICES.NBA_SERVICES
{
    internal class Nba_Data_Api03
    {
        ...
        private static List<string> rel01 = new List<string>();
        private static List<string> href01 = new List<string>();
        private static List<string> text = new List<string>();
        private static List<string> shortText = new List<string>();
        private static List<bool> isExternal = new List<bool>();
        private static List<bool> isPremium = new List<bool>();
        private static List<string> href02 = new List<string>();
        private static List<int> width = new List<int>();
        private static List<int> height = new List<int>();
        private static List<string> alt = new List<string>();
        private static List<string> re02l = new List<string>();
        private static List<string> lastUpdated = new List<string>();
        private static List<string> referee = new List<string>();
        private static List<string> guid = new List<string>();
        private static List<string> uid = new List<string>();
        private static List<string?> name = new List<string?>();
        private static List<string> displayName = new List<string>();
        private static List<string> slug = new List<string>();
        private static List<string> status = new List<string>();
        private static List<string> logoDark = new List<string>();
        private static List<object> seasonType = new List<object>();
        private static List<int?> year = new List<int?>();
        private static List<string> startDate = new List<string>();
        private static List<string> endDate = new List<string>();
        private static List<string> gender = new List<string>();
        private static List<string> shortName = new List<string>();
        private static List<string> abbreviation = new List<string>();
        private static List<bool> isTournament = new List<bool>();
        private static List<string> isTournament01 = new List<string>();
        private static List<string> rel = new List<string>();
        private static List<string> href = new List<string>();
        private static List<string> width01 = new List<string>();
        private static List<string> height01 = new List<string>();
        ...
        private static async Task<string> nba_data01(string input01)
        {
        ...
        private static async Task<string> nba_data02(string input01)
        {
            try
            {
                    ...
                    Headers =
    {
        ...
        private static async Task<string> nba_data03(string input01)
        {
            try
            {
                var request = new HttpRequestMessage
                    ...
                    Headers =
    {
        ...
        private static async Task<string> nba_data04(string input01)
        {
            try
            {
