...
namespace E_APP02.SERVICES.SQL_SERVICES.SQL.SQL_SERVICES.SQL_SERVICES_DEVICE
{
    internal class Sql_Services01
    {
        ...
        private static List<string> Manufacturer = new List<string>();
        private static List<string> Model = new List<string>();
        private static List<string> Name01 = new List<string>();
        private static List<string> VersionString = new List<string>();
        private static List<string> Platform01 = new List<string>();
        private static List<string> Idiom = new List<string>();
        private static List<string> DeviceType = new List<string>();
