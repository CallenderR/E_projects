...
namespace E_APP02.SERVICES.SQL_SERVICES.SQL.SQL_SERVICES.SQL_SERVICES_NBA
{
    ...
    {
        private static List<string> get = new List<string>();
        ...
        private static List<string> response01 = new List<string>();

        private static string[] data01 = new string[100];
        public List<Nba_Set_Model01> collectiondata01 = new List<Nba_Set_Model01>();
        public static string insert_Leagues(string input01, string input02,
