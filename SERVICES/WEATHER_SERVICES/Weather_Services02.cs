...
namespace E_APP02.SERVICES.WEATHER_SERVICES
{
    internal class Weather_Services02
    {
        ...
        private  List<double> dwpt = new List<double>();
        private  List<string> rhum = new List<string>();
        private  List<string> prcp = new List<string>();
        private  List<string?> snow = new List<string?>();
        private  List<string> wdir = new List<string>();
        private  List<double> wspd = new List<double>();
        private  List<string> wpgt = new List<string>();
        private  List<double> pres = new List<double>();
        private  List<int?> tsun = new List<int?>();
        private  List<int> coco = new List<int>();
        private  List<string> id = new List<string>();
        private  List<string> de = new List<string>();
        private  List<string> es = new List<string>();
        private  List<string> en = new List<string>();
        private  List<string> country = new List<string>();
        private  List<string> region = new List<string>();
        private  List<string> national = new List<string>();
        private  List<string> wmo = new List<string>();
        private  List<string> icao = new List<string>();
        private  List<double> latitude = new List<double>();
        private  List<double> longitude = new List<double>();
        private  List<int> elevation = new List<int>();
        private  List<string> timezone = new List<string>();
        private  List<string> start = new List<string>();
        private  List<string> end = new List<string>();
        private  List<string> start01 = new List<string>();
        private  List<string> end01 = new List<string>();
        private  List<string> start02 = new List<string>();
        private  List<string> end02 = new List<string>();
        private  List<int> start03 = new List<int>();
        private  List<int> end03 = new List<int>();
        private  List<int> start04 = new List<int>();
        private  List<int> end04 = new List<int>();
        private  List<double> distance = new List<double>();
        private  List<int> month = new List<int>();
        private  List<double> tavg = new List<double>();
        ...
        public async Task<string> icon_meteostat_GET_Nearby_Stations()
        {
            ...
            string lat = Device_Serv.get_device_ip().Result.Split(',')[0].Trim();
            string lon = Device_Serv.get_device_ip().Result.Split(',')[1].Trim();
