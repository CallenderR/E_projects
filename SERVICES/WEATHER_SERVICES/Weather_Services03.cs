...
namespace E_APP02.SERVICES.WEATHER_SERVICES
{
    internal class Weather_Services03
    {
        ...
        private  List<string> @base = new List<string>();
        private  List<double> temp = new List<double>();
        private  List<double> feels_like = new List<double>();
        private  List<double> temp_min = new List<double>();
        private  List<double> temp_max = new List<double>();
        private  List<int> pressure = new List<int>();
        private  List<int> humidity = new List<int>();
        private  List<int> sea_level = new List<int>();
        private  List<int> grnd_level = new List<int>();
        private  List<int> visibility = new List<int>();
        private  List<double> speed = new List<double>();
        private  List<int> deg = new List<int>();
        private  List<int> all = new List<int>();
        private  List<int> dt = new List<int>();
        private  List<int> type = new List<int>();
        private  List<int> id01 = new List<int>();
        private  List<string> country = new List<string>();
        private  List<int> sunrise = new List<int>();
        private  List<int> sunset = new List<int>();
        private  List<int> timezone = new List<int>();
        private  List<int> id02 = new List<int>();
        private  List<string> name = new List<string>();
        private  List<int> cod = new List<int>();
        ...
        private  List<string> cod01 = new List<string>();
        private  List<int> message = new List<int>();
        private  List<int> cnt = new List<int>();
        private  List<double> temp_kf = new List<double>();
        private List<double> gust = new List<double>();
        private  List<double> pop = new List<double>();
        private  List<string> pod = new List<string>();
        private  List<string> dt_txt = new List<string>();
        private  List<double?> _3h = new List<double?>();
        ...
        {
            string info = await Device_Serv.get_device_ip();
