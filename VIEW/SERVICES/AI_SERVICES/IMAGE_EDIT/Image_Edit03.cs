...
namespace E_APP02.SERVICES.AI_SERVICES.IMAGE_EDIT
{
    ...
    {
        private static List<string> ResultImageUrl = new List<string>();
        private static List<int> FaceSwapCount = new List<int>();
        private static List<bool> Success = new List<bool>();
        private static List<string> Message = new List<string>();
        private static List<int> StatusCode = new List<int>();
        private static List<string> ProcessingTime = new List<string>();
        private static List<string> ProcessingTimeSpan = new List<string>();
        private static List<DateTime?> ProcessStartedDateTime = new List<DateTime?>();
        private static string[] data01 = new string[100];
        private static List<string> ResultUrl = new List<string>();
        private static List<string> image_list01 = new List<string>();
        private static List<int> High = new List<int>();
        private static List<int> Low = new List<int>();
        private static List<double> Confidence = new List<double>();
        private static List<bool> Value = new List<bool>();
        private static List<double> Height = new List<double>();
        private static List<double> Left = new List<double>();
        private static List<double> Top = new List<double>();
        private static List<double> Width = new List<double>();
        private static List<double> Confidence01 = new List<double>();
        private static List<double> Confidence02 = new List<double>();
        private static List<double> Pitch = new List<double>();
        private static List<double> Yaw = new List<double>();
        private static List<double> Confidence03 = new List<double>();
        private static List<string> Value01 = new List<string>();
        private static List<double> Confidence04 = new List<double>();
        private static List<bool> Value02 = new List<bool>();
        private static List<double> Confidence05 = new List<double>();
        private static List<double> Confidence06 = new List<double>();
        private static List<bool> Value03 = new List<bool>();
        private static List<double> Confidence07 = new List<double>();
        private static List<double> X = new List<double>();
        private static List<double> Y = new List<double>();
        private static List<double> Confidence08 = new List<double>();
        private static List<string> Value04 = new List<string>();
        private static List<double> Confidence09 = new List<double>();
        private static List<bool> Value05 = new List<bool>();
        private static List<double> Pitch01 = new List<double>();
        private static List<double> Roll = new List<double>();
        private static List<double> Yaw01 = new List<double>();
        private static List<double> Brightness = new List<double>();
        private static List<double> Sharpness = new List<double>();
        private static List<int> Statuscode = new List<int>();
        private static List<double> Confidence10 = new List<double>();
        private static List<bool> Value06 = new List<bool>();
        private static List<double> Confidence11 = new List<double>();
        private static List<string> Value07 = new List<string>();
        private static List<bool> Value08 = new List<bool>();
        private static List<bool> Value09 = new List<bool>();
        private static List<bool> Value10 = new List<bool>();
        private static List<bool> Value11 = new List<bool>();
