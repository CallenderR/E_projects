...
namespace E_APP02.SERVICES.AI_SERVICES.TEXT_TO_IMAGE
{
    internal class Text_To_Image01
    {
        ...
        private static List<string> prompt_id = new List<string>();
        private static List<string> status = new List<string>();
        private static List<int> index = new List<int>();
        private static List<string> prompt_status = new List<string>();
        private static List<int> index01 = new List<int>();
        private static List<bool> nsfw = new List<bool>();
        private static List<string> origin = new List<string>();
        private static List<string> thumb = new List<string>();
