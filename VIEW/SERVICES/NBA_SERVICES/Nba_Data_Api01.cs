...
namespace E_APP02.SERVICES.NBA_SERVICES
{
    internal class Nba_Data_Api01
    {
        ...
        private static List<int> Season = new List<int>();
        private static List<int> SeasonType = new List<int>();
        private static List<int?> TeamID = new List<int?>();
        private static List<string> Key = new List<string>();
        private static List<string> City = new List<string>();
        private static List<string> Name = new List<string>();
        private static List<string> Conference = new List<string>();
        private static List<string> Division = new List<string>();
        private static List<int> Wins = new List<int>();
        private static List<int> Losses = new List<int>();
        private static List<double> Percentage = new List<double>();
        private static List<int> ConferenceWins = new List<int>();
        private static List<int> ConferenceLosses = new List<int>();
        private static List<int> DivisionWins = new List<int>();
        private static List<int> DivisionLosses = new List<int>();
        private static List<int> HomeWins = new List<int>();
        private static List<int> HomeLosses = new List<int>();
        private static List<int> AwayWins = new List<int>();
        private static List<int> AwayLosses = new List<int>();
        private static List<int> LastTenWins = new List<int>();
        private static List<int> LastTenLosses = new List<int>();
        private static List<double> PointsPerGameFor = new List<double>();
        private static List<double> PointsPerGameAgainst = new List<double>();
        private static List<int> Streak = new List<int>();
        private static List<double> GamesBack = new List<double>();
        private static List<string> StreakDescription = new List<string>();
        private static List<int> GlobalTeamID = new List<int>();
        private static List<int> ConferenceRank = new List<int>();
        private static List<int> DivisionRank = new List<int>();
        private static List<int> PlayerID = new List<int>();
        private static List<string> SportsDataID = new List<string>();
        private static List<string> Status = new List<string>();
        private static List<string> Team = new List<string>();
        private static List<string> Jersey = new List<string>();
        private static List<string> PositionCategory = new List<string>();
        private static List<object> Position = new List<object>();
        private static List<string> FirstName = new List<string>();
        private static List<string> LastName = new List<string>();
        private static List<DateTime?> BirthDate = new List<DateTime?>();
        private static List<string> BirthCity = new List<string>();
        private static List<string> BirthState = new List<string>();
        private static List<string> BirthCountry = new List<string>();
        private static List<string> Height = new List<string>();
        private static List<string> Weight = new List<string>();
        private static List<bool?> Active = new List<bool?>();
        private static List<int> LeagueID = new List<int>();
        private static List<int?> StadiumID = new List<int?>();
        private static List<string> PrimaryColor = new List<string>();
        private static List<string> SecondaryColor = new List<string>();
        private static List<string> TertiaryColor = new List<string>();
        private static List<string> QuaternaryColor = new List<string>();
        private static List<string> WikipediaLogoUrl = new List<string>();
        private static List<object> WikipediaWordMarkUrl = new List<object>();
        private static List<int?> NbaDotComTeamID = new List<int?>();
        private static List<string> HeadCoach = new List<string>();
        private static List<int?> RefereeID = new List<int?>();
        private static List<int> Number = new List<int>();
        private static List<string> College = new List<string>();
        private static List<string> Address = new List<string>();
        private static List<string> State = new List<string>();
        private static List<string> Zip = new List<string>();
        private static List<string> Country = new List<string>();
        private static List<int?> Capacity = new List<int?>();
        private static List<double?> GeoLat = new List<double?>();
        private static List<double?> GeoLong = new List<double?>();
        private static List<int?> Experience = new List<int?>();
        private static List<int> RecordId = new List<int>();
        private static List<int> BettingMarketTypeId = new List<int>();
        private static List<int> BettingBetTypeId = new List<int>();
        private static List<int> BettingPeriodTypeId = new List<int>();
        private static List<bool?> Active01 = new List<bool?>();
        private static List<bool?> Active02 = new List<bool?>();
        private static List<bool?> Active03 = new List<bool?>();
        private static List<bool?> Active04 = new List<bool?>();
        private static List<bool?> Active05 = new List<bool?>();
        private static List<string> Name01 = new List<string>();
        private static List<string> Name02 = new List<string>();
        private static List<string> Name03 = new List<string>();
        private static List<string> Name04 = new List<string>();
        private static List<string> Name05 = new List<string>();
        private static List<int> RecordId01 = new List<int>();
        private static List<int> RecordId02 = new List<int>();
        private static List<int> RecordId03 = new List<int>();
        private static List<int> RecordId04 = new List<int>();
        private static List<int> RecordId05 = new List<int>();
        private static List<int> StartYear = new List<int>();
        private static List<int> EndYear = new List<int>();
        private static List<string> Description = new List<string>();
        private static List<DateTime> RegularSeasonStartDate = new List<DateTime>();
        private static List<DateTime> PostSeasonStartDate = new List<DateTime>();
        private static List<string> ApiSeason = new List<string>();
        private static List<string> SeasonType01 = new List<string>();
        private static List<int> SportsbookID = new List<int>();
        private static List<int> GameID = new List<int>();
        private static List<DateTime> Day = new List<DateTime>();
        private static List<DateTime> DateTime = new List<DateTime>();
        private static List<string> AwayTeam = new List<string>();
        private static List<string> HomeTeam = new List<string>();
        private static List<int> AwayTeamID = new List<int>();
        private static List<int> HomeTeamID = new List<int>();
        private static List<string> Channel = new List<string>();
        private static List<int?> Attendance = new List<int?>();
        private static List<int?> AwayTeamScore = new List<int?>();
        private static List<int?> HomeTeamScore = new List<int?>();
        private static List<DateTime> Updated = new List<DateTime>();
        private static List<object> Quarter = new List<object>();
        private static List<object> TimeRemainingMinutes = new List<object>();
        private static List<object> TimeRemainingSeconds = new List<object>();
        private static List<double?> PointSpread = new List<double?>();
        private static List<double?> OverUnder = new List<double?>();
        private static List<int?> AwayTeamMoneyLine = new List<int?>();
        private static List<int?> HomeTeamMoneyLine = new List<int?>();
        private static List<int> GlobalGameID = new List<int>();
        private static List<int> GlobalAwayTeamID = new List<int>();
        private static List<int> GlobalHomeTeamID = new List<int>();
        private static List<int?> PointSpreadAwayTeamMoneyLine = new List<int?>();
        private static List<int?> PointSpreadHomeTeamMoneyLine = new List<int?>();
        private static List<string> LastPlay = new List<string>();
        private static List<bool> IsClosed = new List<bool>();
        private static List<DateTime?> GameEndDateTime = new List<DateTime?>();
        private static List<int?> HomeRotationNumber = new List<int?>();
        private static List<int?> AwayRotationNumber = new List<int?>();
        private static List<bool> NeutralVenue = new List<bool>();
        private static List<int?> OverPayout = new List<int?>();
        private static List<int?> UnderPayout = new List<int?>();
        private static List<int?> CrewChiefID = new List<int?>();
        private static List<int?> UmpireID = new List<int?>();
        private static List<object> AlternateID = new List<object>();
        private static List<DateTime> DateTimeUTC = new List<DateTime>();
        private static List<bool> InseasonTournament = new List<bool>();
        private static List<object> SeriesInfo = new List<object>();
        private static List<object> Quarters = new List<object>();
        private static List<DateTime> GameEndDateTIme = new List<DateTime>();
        private static List<int> SeasonID = new List<int>();
        private static Sql_Services02 Sql_Ser02= new Sql_Services02();
