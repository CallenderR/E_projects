...
namespace E_APP02.SERVICES.NEWS_SERVICES
{
    internal class News_Services01
    {
        ...
        private static List<string> request_id = new List<string>();
        private static List<string> title = new List<string>();
        private static List<string> link = new List<string>();
        private static List<string> snippet = new List<string>();
        private static List<string> photo_url = new List<string>();
        private static List<string> thumbnail_url = new List<string>();
        private static List<DateTime?> published_datetime_utc = new List<DateTime?>();
        private static List<string> authors = new List<string>();
        private static List<string> source_url = new List<string>();
        private static List<string> source_name = new List<string>();
        private static List<string> source_logo_url = new List<string>();
        private static List<string> source_favicon_url = new List<string>();
        private static List<string> source_publication_id = new List<string>();
        private static List<string> topic_id = new List<string>();
        private static List<string> topic_name = new List<string>();
        private static List<string> story_id = new List<string>();
        private static List<string> post_id = new List<string>();
        private static List<object> photo = new List<object>();
        private static List<string> post_author_username = new List<string>();
        private static List<string> post_author_picture = new List<string>();
        private static List<DateTime> post_datetime_utc = new List<DateTime>();
        private static List<string> name = new List<string>();
        private static List<string> lang = new List<string>();
