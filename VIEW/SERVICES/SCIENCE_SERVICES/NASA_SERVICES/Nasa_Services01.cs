...
namespace E_APP02.SERVICES.SCIENCE_SERVICES.NASA_SERVICES
{
    internal class Nasa_Services01
    {
        ...
        private static List<string> copyright = new List<string>();
        private static List<string> date = new List<string>();
        private static List<string> explanation = new List<string>();
        private static List<string> hdurl = new List<string>();
        private static List<string> media_type = new List<string>();
        private static List<string> service_version = new List<string>();
        private static List<string> title = new List<string>();
        private static List<string> url = new List<string>();


        //link
        private static List<string> next = new List<string>();
        private static List<string> previous = new List<string>();
        private static List<string> self = new List<string>();
        private static List<int> element_count = new List<int>();
        private static List<string> next01 = new List<string>();
        private static List<string> previous01 = new List<string>();
        private static List<string> self01 = new List<string>();
        private static List<string> id = new List<string>();
        private static List<string> neo_reference_id = new List<string>();
        private static List<string> name = new List<string>();
        private static List<string> nasa_jpl_url = new List<string>();
        private static List<double> absolute_magnitude_h = new List<double>();
        private static List<double> estimated_diameter_min = new List<double>();
        private static List<double> estimated_diameter_max = new List<double>();
        private static List<double> estimated_diameter_min01 = new List<double>();
        private static List<double> estimated_diameter_max01 = new List<double>();
        private static List<double> estimated_diameter_min02 = new List<double>();
        private static List<double> estimated_diameter_max02 = new List<double>();
        private static List<double> estimated_diameter_min03 = new List<double>();
        private static List<double> estimated_diameter_max03 = new List<double>();
        private static List<bool> is_potentially_hazardous_asteroid = new List<bool>();
        private static List<string> close_approach_date = new List<string>();
        private static List<string> close_approach_date_full = new List<string>();
        private static List<object> epoch_date_close_approach = new List<object>();
        private static List<string> kilometers_per_second = new List<string>();
        private static List<string> kilometers_per_hour = new List<string>();

        private static List<string> miles_per_hour = new List<string>();
        private static List<string> astronomical = new List<string>();
        private static List<string> lunar = new List<string>();
        private static List<string> kilometers = new List<string>();
        private static List<string> miles = new List<string>();
        private static List<string> orbiting_body = new List<string>();
        private static List<bool> is_sentry_object = new List<bool>();



        private static List<string> activityID = new List<string>();
        private static List<string> catalog = new List<string>();
        private static List<string> startTime = new List<string>();
        private static List<string> displayName = new List<string>();
        private static List<string> sourceLocation = new List<string>();
        private static List<object> activeRegionNum = new List<object>();
        private static List<string> note = new List<string>();
        private static List<string> submissionTime = new List<string>();
        private static List<int> versionId = new List<int>();
        private static List<string> link = new List<string>();
        private static List<bool?> isMostAccurate = new List<bool?>();
        private static List<string> time21_5 = new List<string>();
        private static List<double> latitude = new List<double>();
        private static List<double> longitude = new List<double>();
        private static List<double> halfAngle = new List<double>();
        private static List<double> speed = new List<double>();
        private static List<string> type = new List<string>();
        private static List<string> featureCode = new List<string>();
        private static List<object> imageType = new List<object>();
        private static List<string> measurementTechnique = new List<string>();
        private static List<string> note01 = new List<string>();
        private static List<int> levelOfData = new List<int>();
        private static List<object> tilt = new List<object>();
        private static List<object> minorHalfWidth = new List<object>();
        private static List<object> speedMeasuredAtHeight = new List<object>();
        private static List<string> submissionTime01 = new List<string>();
        private static List<string> link01 = new List<string>();
        private static List<string> modelCompletionTime = new List<string>();
        private static List<double> au = new List<double>();
        private static List<object> estimatedShockArrivalTime = new List<object>();
        private static List<object> estimatedDuration = new List<object>();
        private static List<object> rmin_re = new List<object>();
        private static List<object> kp_18 = new List<object>();
        private static List<object> kp_90 = new List<object>();
        private static List<object> kp_135 = new List<object>();
        private static List<object> kp_180 = new List<object>();
        private static List<bool?> isEarthGB = new List<bool?>();
        private static List<bool?> isEarthMinorImpact = new List<bool?>();
        private static List<string> link02 = new List<string>();
        private static List<bool?> isGlancingBlow = new List<bool?>();
        private static List<bool?> isMinorImpact = new List<bool?>();
        private static List<string> location = new List<string>();
        private static List<string> arrivalTime = new List<string>();
        private static List<string> cmeIDs = new List<string>();
        private static List<object> linkedEvents = new List<object>();
        private static List<string> messageID = new List<string>();
        private static List<string> messageIssueTime = new List<string>();
        private static List<string> messageURL = new List<string>();
        private static List<string> gstID = new List<string>();
        private static List<string> observedTime = new List<string>();
        private static List<double> kpIndex = new List<double>();
        private static List<string> source = new List<string>();
        private static List<string> flrID = new List<string>();
        private static List<string> beginTime = new List<string>();
        private static List<string> peakTime = new List<string>();
        private static List<string> endTime = new List<string>();
        private static List<string> classType = new List<string>();
        private static List<object> sentNotifications = new List<object>();
        private static List<string> sepID = new List<string>();
        private static List<string> eventTime = new List<string>();
        private static List<string> mpcID = new List<string>();
        private static List<string> rbeID = new List<string>();
        ...
        private static List<double> av = new List<double>();
        private static List<int> ct = new List<int>();
        private static List<double> mn = new List<double>();
        private static List<double> mx = new List<double>();
        private static List<int> sol_hours_with_data = new List<int>();
        private static List<bool> valid = new List<bool>();
        private static List<DateTime> First_UTC = new List<DateTime>();
        private static List<double> av01 = new List<double>();
        private static List<int> ct01 = new List<int>();
        private static List<double> mn01 = new List<double>();
        private static List<double> mx01 = new List<double>();
        private static List<int> sol_hours_with_data01 = new List<int>();
        private static List<bool> valid01 = new List<bool>();
        private static List<DateTime> Last_UTC = new List<DateTime>();
        private static List<int> Month_ordinal = new List<int>();
        private static List<string> Northern_season = new List<string>();
        private static List<double> av02 = new List<double>();
        private static List<int> ct02 = new List<int>();
        private static List<double> mn02 = new List<double>();
        private static List<double> mx02 = new List<double>();
        private static List<int> sol_hours_with_data02 = new List<int>();
        private static List<bool> valid02 = new List<bool>();
        private static List<string> Season = new List<string>();
        private static List<string> Southern_season = new List<string>();
        private static List<double> compass_degrees = new List<double>();
        private static List<string> compass_point = new List<string>();
        private static List<double> compass_right = new List<double>();
        private static List<double> compass_up = new List<double>();
        private static List<int> ct03 = new List<int>();
        private static List<double> compass_degrees01 = new List<double>();
        private static List<string> compass_point01 = new List<string>();
        private static List<double> compass_right01 = new List<double>();
        private static List<double> compass_up01 = new List<double>();
        private static List<int> ct04 = new List<int>();
        private static List<double> compass_degrees02 = new List<double>();
        private static List<string> compass_point02 = new List<string>();
        private static List<double> compass_right02 = new List<double>();
        private static List<double> compass_up02 = new List<double>();
        private static List<int> ct05 = new List<int>();
        private static List<double> compass_degrees03 = new List<double>();
        private static List<string> compass_point03 = new List<string>();
        private static List<double> compass_right03 = new List<double>();
        private static List<double> compass_up03 = new List<double>();
        private static List<int> ct06 = new List<int>();
        private static List<double> compass_degrees04 = new List<double>();
        private static List<string> compass_point04 = new List<string>();
        private static List<double> compass_right04 = new List<double>();
        private static List<double> compass_up04 = new List<double>();
        private static List<int> ct07 = new List<int>();
        private static List<double> compass_degrees05 = new List<double>();
        private static List<string> compass_point05 = new List<string>();
        private static List<double> compass_right05 = new List<double>();
        private static List<double> compass_up05 = new List<double>();
        private static List<int> ct08 = new List<int>();
        private static List<double> compass_degrees06 = new List<double>();
        private static List<string> compass_point06 = new List<string>();
        private static List<double> compass_right06 = new List<double>();
        private static List<double> compass_up06 = new List<double>();
        private static List<int> ct09 = new List<int>();
        private static List<double> compass_degrees07 = new List<double>();
        private static List<string> compass_point07 = new List<string>();
        private static List<double> compass_right07 = new List<double>();
        private static List<double> compass_up07 = new List<double>();
        private static List<int> ct10 = new List<int>();
        private static List<double> compass_degrees08 = new List<double>();
        private static List<string> compass_point08 = new List<string>();
        private static List<double> compass_right08 = new List<double>();
        private static List<double> compass_up08 = new List<double>();
        private static List<int> ct11 = new List<int>();
        private static List<double> compass_degrees09 = new List<double>();
        private static List<string> compass_point09 = new List<string>();
        private static List<double> compass_right09 = new List<double>();
        private static List<double> compass_up09 = new List<double>();
        private static List<int> ct12 = new List<int>();
        private static List<double> compass_degrees10 = new List<double>();
        private static List<string> compass_point10 = new List<string>();
        private static List<double> compass_right10 = new List<double>();
        private static List<double> compass_up10 = new List<double>();
        private static List<int> ct13 = new List<int>();
