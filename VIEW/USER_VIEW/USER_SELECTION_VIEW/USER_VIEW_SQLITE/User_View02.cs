        ...
        private void load_User_View03()
        {
            ...
            switch (int.Parse(data01[1]))
            {
                case 1:
                    ...
                    data01[3] = $"{Sqlite_Serv01.find_email_using_email(data01[2])}";
                ...
                case 2:
                    ...
                    data01[6] = $"{Sqlite_Serv01.find_email_using_email(data01[5])}";
                ...
                case 3:
                    ...
                    data01[9] = $"{Sqlite_Serv01.find_phonenumber_using_email(data01[8])}";
                ...
                case 4:
                    ...
                    data01[12] = $"{Sqlite_Serv01.find_phonenumber_using_username(data01[11])}";
                ...
                case 5:
                    ...
                    data01[15] = $"{Sqlite_Serv01.find_phonenumber_using_phonenumber(data01[14])}";
                    Console.WriteLine(data01[15]);
                    break;
                case 6:
                    data01[16] = "Email address\n";
                    Console.WriteLine(data01[16]);
                    data01[17] = Console.ReadLine();
                    data01[18] = $"{Sqlite_Serv01.find_user_location_using_email(data01[17])}";
                    Console.WriteLine(data01[19]);
                    break;
                case 7:
                    data01[20] = "username\n";
                    Console.WriteLine(data01[20]);
                    data01[21] = Console.ReadLine();
                    data01[22] = $"{Sqlite_Serv01.find_user_location_using_username(data01[21])}";
                    Console.WriteLine(data01[22]);
                    break;
                case 8:
                    data01[23] = "Email address\n";
                    Console.WriteLine(data01[24]);
                    data01[25] = Console.ReadLine();
                    data01[26] = $"{Sqlite_Serv01.find_username_using_email(data01[24])}";
                ...
                case 9:
                    ...
                    data01[30] = $"{Sqlite_Serv01.find_username_using_username(data01[29])}";
                    Console.WriteLine(data01[30]);
                    break;
                case 10:
                    data01[31] = "Email address\n";
                    Console.WriteLine(data01[31]);
                    data01[32] = Console.ReadLine();
                    data01[33] = $"{Sqlite_Serv01.find_password_using_email(data01[32])}";
                    Console.WriteLine(data01[33]);
                    break;
                case 11:
                    data01[34] = "username\n";
                    Console.WriteLine(data01[34]);
                    data01[35] = Console.ReadLine();
                    data01[36] = $"{Sqlite_Serv01.find_password_using_username(data01[35])}";
